...
export default function Navbar() {
    return (
        <nav className="absolute bottom-0 left-0 flex flex-row justify-between w-full px-6 pt-2 pb-6 bg-card border-t-1" style={{ zIndex: 10, viewTransitionName: 'bottom-navbar' }}>
