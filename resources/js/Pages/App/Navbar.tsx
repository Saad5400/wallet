...
export default function Navbar() {
    return (
        <nav className="w-full bg-card border-t-1 absolute bottom-0 px-6 pb-6 pt-2 flex flex-row justify-between" style={{ zIndex: 10, viewTransitionName: 'bottom-navbar' }}>
