...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./root/wallet/public/storage' => 'string',
            ...
            'otp.format' => 'string',
            'otp.customize' => 'string',
            'otp.length' => 'integer',
            'otp.separator' => 'string',
            'otp.sensitive' => 'boolean',
            'otp.expires' => 'integer',
            'otp.attempts' => 'integer',
            'otp.repeated' => 'boolean',
            'otp.disposable' => 'boolean',
            'otp.prefix' => 'string',
            'otp.demo' => 'boolean',
            'otp.demo_passwords' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./root/wallet/public/storage','logging.default',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','otp.format',
'otp.customize','otp.length','otp.separator','otp.sensitive','otp.expires',
'otp.attempts','otp.repeated','otp.disposable','otp.prefix','otp.demo',
'otp.demo_passwords','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'broadcasting.connections.null.driver','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist','inertia.testing.page_paths',
...
'sanctum.csrf-cookie','welcome','welcome.email',
